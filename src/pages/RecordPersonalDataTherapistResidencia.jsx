...
function RecordPersonalDataTherapistResidencia() {
        ...
        <div className="bg-card rounded-xl shadow-lg p-8 space-y-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">Terapeuta (Residencia)</p>
            </div>
          </div>
          
          <div className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-base">Nombre completo del terapeuta</Label>
              <input
                id="fullName"
                type="text"
...
export default RecordPersonalDataTherapistResidencia
