...
function RecordPersonalDataDoctorCasa() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-8">Registro de Datos - Médico (Desde Casa)</h1>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          <Label htmlFor="taxStatus">Constancia de situación fiscal actualizada emitida por el SAT2</Label>
          <input
            id="taxStatus"
            type="text"
            className="w-full rounded-md border border-input px-3 py-2"
        ...
        <div className="mt-8 p-4 bg-muted rounded-lg">
          <p className="text-sm text-muted-foreground">
            Documentación para el trámite y pago: Cada que brinde atención médica deberá emitir una Factura electrónica (CFDI) que cumpla con los requisitos fiscales, incluyendo desglose de IVA y retenciones correspondientes para que su pago sea generado. Cuando emita su factura se generará un recibo o comprobante de honorarios que ampare el pago realizado.
          </p>
        </div>
...
export default RecordPersonalDataDoctorCasa
