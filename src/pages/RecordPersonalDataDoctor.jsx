...
import { UserPlus, FileText, Save, AlertCircle, Mail, Phone, MapPin } from "lucide-react"

function RecordPersonalDataDoctor() {
        ...
        <div className="bg-card rounded-xl shadow-lg p-8 space-y-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">Médico</p>
            </div>
          </div>
...
export default RecordPersonalDataDoctor 