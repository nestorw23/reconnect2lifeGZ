...
import { UserPlus, FileText, Save, AlertCircle } from "lucide-react"

function RecordPersonalDataDoctorResidencia() {
        ...
        <div className="bg-card rounded-xl shadow-lg p-8 space-y-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">Médico (Residencia)</p>
            </div>
          </div>
          
          <div className="space-y-6">
            <div className="space-y-2">
              <Label htmlFor="fullName" className="text-base">Nombre completo del médico</Label>
              <input
                id="fullName"
                type="text"
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <Label htmlFor="professionalLicense" className="text-base">Cédula profesional vigente</Label>
              </div>
              <input
            ...
            <div className="bg-muted/50 p-6 rounded-lg border border-border">
              ...
              <p className="text-sm text-muted-foreground">
                La residencia, como contratante directa, debe encargarse de solicitar y validar toda la documentación necesaria para cumplir con las obligaciones fiscales, laborales y profesionales (como RFC, CURP, comprobantes fiscales, contratos, etc. Del médico). ReConnect2Life no maneja datos sensibles o personales del médico que trabaja en un residencia por lo tanto no asume responsabilidades legales relacionadas con la privacidad, manejo de datos o cumplimiento fiscal. En cuanto a la confidencialidad y manejo de información clínica, es responsabilidad del médico y la residencia cumplir con la normatividad aplicable (NOM-024-SSA3-2012, NOM-004-SSA3-2012, LFPDPPP, NOM-168-SSA1-1998).
              </p>
            </div>
...
export default RecordPersonalDataDoctorResidencia
